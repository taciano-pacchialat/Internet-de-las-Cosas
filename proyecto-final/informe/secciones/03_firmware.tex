...
El temporizador del RTC activa el sistema periódiente cada 30~segundos. La Figura~\ref{fig:edge_states} ilustra el flujo secuencial de tareas ejecutado en cada ciclo de \textit{Wakeup}.
